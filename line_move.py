...
def line_update():
    ...
    for robot in robot_points:
        robot1, robot2 = get_random_robots()
        ...
        if distance_to_r1 < distance_to_r2:
            ...
            # print out the robot name and the position it moves to
        else:
            to_move_positions.append(robot2.get_xdata())
    print([m.name for m in robot_list], [m[0] for m in to_move_positions])
